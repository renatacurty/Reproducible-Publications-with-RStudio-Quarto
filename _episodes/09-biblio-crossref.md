...
**[FIXME - the panel insert cross-references in the GUI seems not to be working. Add a note if that remains true before the day of the workshop]**

If you wish to add a cross-reference to a figure that was generated via code block, you have to use a label (id) and caption at the beggining of the figure code block.
